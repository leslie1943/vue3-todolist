{
  mode: 'production',
    context: 'C:\\Leslie\\Web_learning\\vue3-todolist',
      devtool: 'source-map',
        node: {
    setImmediate: false,
      process: 'mock',
  ...
  output: {
    path: 'C:\\Leslie\\Web_learning\\vue3-todolist\\dist',
  ...
  resolve: {
    alias: {
      '@': 'C:\\Leslie\\Web_learning\\vue3-todolist\\src',
    ...
    extensions: [
      ...
      modules: [
        'node_modules',
        'C:\\Leslie\\Web_learning\\vue3-todolist\\node_modules',
      ...
      rules: [
        /* config.module.rule('vue') */
        {
          ...
          use: [
            ...
            {
              loader: 'C:\\Leslie\\Web_learning\\vue3-todolist\\node_modules\\cache-loader\\dist\\cjs.js',
              options: {
                cacheDirectory: 'C:\\Leslie\\Web_learning\\vue3-todolist\\node_modules\\.cache\\vue-loader',
                cacheIdentifier: 'b31ae99a'
              }
            },
          ...
          use: [
            /* config.module.rule('eslint').use('eslint-loader') */
            {
              ...
              options: {
                ...
                cache: true,
                cacheIdentifier: '14baf0fc',
                emitWarning: false,
                emitError: false,
                eslintPath: 'C:\\Leslie\\Web_learning\\vue3-todolist\\node_modules\\eslint',
                formatter: undefined
              }
            }
          ]
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\Leslie\\Web_learning\\vue3-todolist\\public\\index.html'
      }
    ),
    ...
    new CopyPlugin(
      [
        {
          from: 'C:\\Leslie\\Web_learning\\vue3-todolist\\public',
          to: 'C:\\Leslie\\Web_learning\\vue3-todolist\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
